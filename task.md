...
- сервис analytics для сбора количество больших денежных переводов (**gw-analytics**)
...
### 5. Разработка микросервиса аналитики (gw-analytics)

Сервис, получает уведомление от кошелька через брокер сообщений

Необходимо разработать микросервис, который:

1. Количество событий по типам/статусам
2. Latency от создания события до доставки
3. Частота ошибок/ретраев
4. Агрегация по периодам: 1 мин, 5 мин, 1 час, 1 день, 1 неделя.
